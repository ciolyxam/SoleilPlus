...
public class Equipe {
    ...
    public void     afficherJourNonPlein (int semaine) {
        System.out.println("Les jours non complet de l'equipe de "+re.getDetails()+" de la semaine "+semaine+" sont :");
    ...
    public void    afficherToutesInterventions (){
         for (int numSemaine = 0 ; numSemaine<Planning.getNbSemaines(); numSemaine++){
             for (int numJour = 0 ; numJour<Planning.getNbJours(); numJour++){
                System.out.println("interventions de l'equipe de "+re.getDetails()+" de la semaine "+numSemaine+" le "+Planning.TAB_SEMAINE[numJour]);
